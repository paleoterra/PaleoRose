...
final class XRGridInspector: NSViewController {
    ...
    @IBOutlet private var viewPopup: NSPopUpButton!
    @IBOutlet private var spokeFont: NSComboBox!
    @IBOutlet private var ringFont: NSComboBox!
    @IBOutlet private var ringPercentBox: NSTextField!
    @IBOutlet private var spokeFontSize: NSTextField!
    @IBOutlet private var spokeFontSizeStepper: NSStepper!
